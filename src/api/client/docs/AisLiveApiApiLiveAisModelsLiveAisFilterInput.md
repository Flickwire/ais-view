...
```typescript
import type { AisLiveApiApiLiveAisModelsLiveAisFilterInput } from ''
...
const example = {
  ...
  "downsample": null,
} satisfies AisLiveApiApiLiveAisModelsLiveAisFilterInput
...
const exampleParsed = JSON.parse(exampleJSON) as AisLiveApiApiLiveAisModelsLiveAisFilterInput
